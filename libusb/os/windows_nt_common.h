...
int prepare_windows_overlapped(struct libusb_context *ctx, struct windows_overlapped *ov, HANDLE handle);
void cancel_windows_overlapped(struct libusb_context *ctx, struct windows_overlapped *ov);
void clear_windows_overlapped(struct libusb_context *ctx, struct windows_overlapped *ov);
